...
rd temp /S /Q
cd ..
7z a -tZip datacrow_3_12_2_source .\datacrow
cd datacrow
call build.bat
rd _classes /S /Q
rd _source /S /Q
...
del *.project
cd ..
7z a -tZip datacrow_3_12_2_zipped .\datacrow
7z a -tZip datacrow_3_12_2_installer installer.jar installer.sh installer.txt
7z a -tZip datacrow_3_12_2_windows_installer installer.jar setup32bit.exe setup64bit.exe readme.txt
del installer.sh
del installer.txt
del installer.jar
del setup32bit.exe
