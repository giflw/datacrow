...
public class AboutDialog extends DcDialog {
    ...
    private void buildDialog() {
        ...
        try {
            about.setValue(new URL("file://" + DataCrow.baseDir + "icons_system/aboutinformation.jpg"));
        ...
        try {
            credits.setValue(new URL("file://" + DataCrow.baseDir + "icons_system/aboutcredits.jpg"));
