...
public class DcAudioCDListHwElement extends DcObjectListHwElement {
    ...
    protected JTextArea getTracksField() {
        ...
        for (DcObject audioTrack : dco.getChildren()) {
            ...
            title = (String) audioTrack.getValue(AudioTrack._A_TITLE);
            title = title == null ? "" : title; 
            
            i = (Long) audioTrack.getValue(AudioTrack._H_PLAYLENGTH);
            length = i == null || i.equals(Long.valueOf(0)) ? "" : " " + audioTrack.getDisplayString(AudioTrack._H_PLAYLENGTH);
