...
public class PanelModules extends ModuleWizardPanel {

    private int selectedModule = -1;
    
    public PanelModules(Wizard wizard) {
        super(wizard);
        build();
    }
    ...
    private void build() {
        ...
        for (DcModule module : DcModules.getAllModules()) {
            ...
            if (    module instanceof DcPropertyModule && module.getXmlModule() != null || (
                ...
                JRadioButton rb = ComponentFactory.getRadioButton(
                        module.getLabel(), module.getIcon16(), "" + module.getIndex());
