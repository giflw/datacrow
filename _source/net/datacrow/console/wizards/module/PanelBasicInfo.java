...
public class PanelBasicInfo extends ModuleWizardPanel {
    ...
    private void build() {
        ...
        pic16 = ComponentFactory.getIconSelectField(new DcImageIcon(DataCrow.baseDir + "icons_system/icon16.png"));
        pic32 = ComponentFactory.getIconSelectField(new DcImageIcon(DataCrow.baseDir + "icons_system/icon32.png"));
