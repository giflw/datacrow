...
//    private static Object linkage;
    ...
    private static Object locateBrowser() {
        String userBrowser = DcSettings.getString(DcRepository.Settings.stBrowserPath);
        
        if (!userBrowser.equals("")) {
        	browser = userBrowser;
        }
    ...
    public static void openURL(String url) throws IOException {
        ...
        if (!DcSettings.getString(DcRepository.Settings.stBrowserPath).equals("")) {
            try {
                Runtime.getRuntime().exec(new String[] { (String) browser, url });
                return;
            } catch (Exception exp) {
                String message = "Unable to start selected the browser using '" + browser + "'. " +
                                 "Either clear or correct the setting browser path (settings > hhtp)";
                browser = null;
