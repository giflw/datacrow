            ...
            <fo:table table-layout="fixed" width="100%" border-collapse="separate" space-before="10">
              ...
              <fo:table-body>
                ...
                <fo:table-row height="{$rowHeight}">
                  ...
                  <fo:table-cell><fo:block><xsl:for-each select="genres/genre"><xsl:value-of select="name"/>&#160;</xsl:for-each></fo:block></fo:table-cell>
                </fo:table-row>
                <fo:table-row height="{$rowHeight}">
                ...
                <fo:table-row height="{$rowHeight}">
                  <fo:table-cell><fo:block font-weight="bold">Actors</fo:block></fo:table-cell>
                  <fo:table-cell><fo:block><xsl:for-each select="actors/actor"><xsl:value-of select="name"/>&#160;</xsl:for-each></fo:block></fo:table-cell>
                </fo:table-row>
                <fo:table-row height="{$rowHeight}">
                  <fo:table-cell><fo:block font-weight="bold">Directors</fo:block></fo:table-cell>
                  <fo:table-cell><fo:block><xsl:for-each select="directors/director"><xsl:value-of select="name"/>&#160;</xsl:for-each></fo:block></fo:table-cell>
                </fo:table-row>
                <fo:table-row height="{$rowHeight}">
                  <fo:table-cell><fo:block font-weight="bold">Playlength</fo:block></fo:table-cell>
