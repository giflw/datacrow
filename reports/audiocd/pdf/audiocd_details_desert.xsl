      ...
      <fo:page-sequence master-reference="A4">
        ...
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block font-size="{$fontSize}">
            ...
            <fo:table table-layout="fixed" width="14cm" border-collapse="separate" background-color="{$textColor}">
            ...
            <fo:table-cell>
              <fo:block>
                <fo:table background-color="{$textColor}" table-layout="fixed" width="9cm" border-collapse="separate">
            ...
            <fo:table-cell>
              <fo:block>
                <xsl:if test="picture-front != ''">
                  <fo:table table-layout="fixed" width="{$pictureSize}" border-collapse="separate">
                    <fo:table-body>
                      <fo:table-row>
                        <fo:table-cell>
                          <fo:block>
          ...
          <fo:block font-size="{$fontSize}" space-before="20">
            <fo:table background-color="{$textColor}" table-layout="fixed" width="14cm" border-collapse="separate">
              ...
              <fo:table-header>
                <fo:table-row height="{$rowHeight}">
                  <fo:table-cell background-color="{$labelColor}" padding-top="{$paddingTop}" padding-left="{$paddingLeft}"><fo:block font-weight="bold">Nr</fo:block></fo:table-cell>
                  <fo:table-cell background-color="{$labelColor}" padding-top="{$paddingTop}" padding-left="{$paddingLeft}"><fo:block font-weight="bold">Title</fo:block></fo:table-cell>
                  <fo:table-cell background-color="{$labelColor}" padding-top="{$paddingTop}" padding-left="{$paddingLeft}"><fo:block font-weight="bold">Length</fo:block></fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              ...
              <fo:table-body>
                <xsl:for-each select="audio-tracks/audio-track">
                    <fo:table-row height="{$rowHeight}">
                        <fo:table-cell padding-top="{$paddingTop}" padding-left="{$paddingLeft}"><fo:block><xsl:value-of select="track"/></fo:block></fo:table-cell>
                        <fo:table-cell padding-top="{$paddingTop}" padding-left="{$paddingLeft}"><fo:block><xsl:value-of select="title"/></fo:block></fo:table-cell>
                        <fo:table-cell padding-top="{$paddingTop}" padding-left="{$paddingLeft}"><fo:block><xsl:value-of select="playlength"/></fo:block></fo:table-cell>
                    </fo:table-row>
                </xsl:for-each>
              </fo:table-body>
            </fo:table>
