          ...
          <fo:block font-size="{$fontSize}">
            <fo:table table-layout="fixed" width="100%" border-collapse="separate" space-before="10">
              ...
              <fo:table-body>
                ...
                <fo:table-row height="{$rowHeight}">
                  <fo:table-cell><fo:block font-weight="bold">Categories</fo:block></fo:table-cell>
                  <fo:table-cell><fo:block><xsl:for-each select="categories/category"><xsl:value-of select="name"/>&#160;</xsl:for-each></fo:block></fo:table-cell>
                </fo:table-row>
                ...
                <fo:table-row height="{$rowHeight}">
                  ...
                  <fo:table-cell><fo:block><xsl:for-each select="developers/developer"><xsl:value-of select="name"/>&#160;</xsl:for-each></fo:block></fo:table-cell>
                </fo:table-row>
