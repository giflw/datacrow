			...
			<xsl:for-each select="data-crow-objects/software-item">
				<fo:page-sequence master-reference="A4">
					...
					<fo:flow flow-name="xsl-region-body">
								...
								<fo:table-body>
									<fo:table-row height="{$rowHeight}">
										...
										<fo:table-cell padding-top="{$paddingTop}"
											padding-left="{$paddingLeft}" padding-bottom="10">
											<fo:block>
						...
						<xsl:if
							test="picture-front != '' or screenshot-one != '' or screenshot-two != ''">
							<fo:table table-layout="fixed" width="100%"
											...
											<fo:table-cell>
												<fo:block>
													<fo:external-graphic content-width="{$pictureSize}"
														content-height="{$pictureSize}" scaling="uniform">
														<xsl:attribute name="src">url('<xsl:value-of
															select="screenshot-one" />')</xsl:attribute>
													</fo:external-graphic>
												</fo:block>
											</fo:table-cell>
										</xsl:if>
											...
											<fo:table-cell>
												<fo:block>
													<fo:external-graphic content-width="{$pictureSize}"
														content-height="{$pictureSize}" scaling="uniform">
														<xsl:attribute name="src">url('<xsl:value-of
															select="screenshot-two" />')</xsl:attribute>
													</fo:external-graphic>
												</fo:block>
											</fo:table-cell>
										</xsl:if>
