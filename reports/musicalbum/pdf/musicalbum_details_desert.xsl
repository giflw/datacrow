      ...
      <fo:page-sequence master-reference="A4">
        ...
        <fo:flow flow-name="xsl-region-body">
          ...
          <fo:block font-size="{$fontSize}">
            ...
            <fo:table table-layout="fixed" width="14cm" border-collapse="separate" background-color="{$textColor}" space-before="10">
                  ...
                  <fo:table-body>
                    ...
                    <fo:table-row height="{$rowHeight}">
                      ...
                      <fo:table-cell padding-top="{$paddingTop}" padding-left="{$paddingLeft}">
                        <fo:block><xsl:for-each select="artists/artist"><xsl:value-of select="name"/>&#160;</xsl:for-each></fo:block>
                       </fo:table-cell>
                    </fo:table-row>
          ...
          <fo:block font-size="{$fontSize}" space-before="20">
            <fo:table background-color="{$textColor}" table-layout="fixed" width="14cm" border-collapse="separate">
              ...
              <fo:table-header>
                <fo:table-row height="{$rowHeight}">
                  <fo:table-cell background-color="{$labelColor}"><fo:block font-weight="bold">Nr</fo:block></fo:table-cell>
                  <fo:table-cell background-color="{$labelColor}"><fo:block font-weight="bold">Title</fo:block></fo:table-cell>
                  <fo:table-cell background-color="{$labelColor}"><fo:block font-weight="bold">Length</fo:block></fo:table-cell>
                </fo:table-row>
              </fo:table-header>
