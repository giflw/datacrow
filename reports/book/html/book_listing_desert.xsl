    ...
    <table cellspacing="0" cellpadding="10">
      ...
      <xsl:for-each select="data-crow-objects/book">
        <tr>
          ...
          <td class="listing"><xsl:for-each select="authors/author"><xsl:value-of select="name"/>&#160;</xsl:for-each>&#x00A0;</td>
          <td class="listing"><xsl:for-each select="publishers/publisher"><xsl:value-of select="name"/>&#160;</xsl:for-each>&#x00A0;</td>
